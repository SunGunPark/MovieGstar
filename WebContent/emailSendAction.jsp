...
<%
	...
	String host = "http://localhost:8080/Movie_Star/";
	String from = "z5318330@gmail.com";
	String to = userDAO.getUserEmail(userID);
	String subject = "MovieGStar 회원가입 인증 메일입니다";
...
<head>
	...
	<title>영화평가 사이트</title>
	<link rel="stylesheet" href="./css/bootstrap.min.css">
	<link rel="stylesheet" href="./css/custom.css">
</head>
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="index.jsp">영화평가 사이트</a>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2019 박성운 All Rights Reservered.
	</footer>
